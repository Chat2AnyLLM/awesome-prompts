...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2633 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2638 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2114 |
...
<details>
<summary><strong>Prompts Chat</strong> (2114 prompts)</summary>
...
| … | *+2084 more* | See `scraped/prompts-chat/` |
