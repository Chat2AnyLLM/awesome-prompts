...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2404 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2409 |
...
| AI Boost Awesome Prompts | github | [https://github.com/ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) | txt | 317 |

### Scraped Prompts

<details>
<summary><strong>Ai Boost Awesome Prompts</strong> (317 prompts)</summary>
...
| … | *+287 more* | See `scraped/ai-boost-awesome-prompts/` |
