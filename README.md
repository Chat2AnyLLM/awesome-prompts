...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2580 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2585 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2066 |
...
| AI Boost Awesome Prompts | github | [https://github.com/ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) | txt | 356 |

### Scraped Prompts

<details>
<summary><strong>Ai Boost Awesome Prompts</strong> (356 prompts)</summary>
...
| … | *+326 more* | See `scraped/ai-boost-awesome-prompts/` |
...
<details>
<summary><strong>Prompts Chat</strong> (2066 prompts)</summary>
...
| … | *+2036 more* | See `scraped/prompts-chat/` |
