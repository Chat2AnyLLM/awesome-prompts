...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2548 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2553 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2043 |
...
| AI Boost Awesome Prompts | github | [https://github.com/ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) | txt | 347 |

### Scraped Prompts

<details>
<summary><strong>Ai Boost Awesome Prompts</strong> (347 prompts)</summary>
...
| … | *+317 more* | See `scraped/ai-boost-awesome-prompts/` |
...
<details>
<summary><strong>Prompts Chat</strong> (2043 prompts)</summary>
...
| … | *+2013 more* | See `scraped/prompts-chat/` |
