...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2554 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2559 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2049 |
...
<details>
<summary><strong>Prompts Chat</strong> (2049 prompts)</summary>
...
| … | *+2019 more* | See `scraped/prompts-chat/` |
