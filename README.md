...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2538 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2543 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2038 |
...
| AI Boost Awesome Prompts | github | [https://github.com/ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) | txt | 342 |

### Scraped Prompts

<details>
<summary><strong>Ai Boost Awesome Prompts</strong> (342 prompts)</summary>
...
| … | *+312 more* | See `scraped/ai-boost-awesome-prompts/` |
...
<details>
<summary><strong>Prompts Chat</strong> (2038 prompts)</summary>
...
| … | *+2008 more* | See `scraped/prompts-chat/` |
