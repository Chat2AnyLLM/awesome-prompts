...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2601 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2606 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2084 |
...
<details>
<summary><strong>Prompts Chat</strong> (2084 prompts)</summary>
...
| … | *+2054 more* | See `scraped/prompts-chat/` |
