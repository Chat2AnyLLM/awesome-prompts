...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2646 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2651 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2127 |
...
<details>
<summary><strong>Prompts Chat</strong> (2127 prompts)</summary>
...
| … | *+2097 more* | See `scraped/prompts-chat/` |
