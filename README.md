...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2456 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2461 |
...
| AI Boost Awesome Prompts | github | [https://github.com/ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) | txt | 324 |

### Scraped Prompts

<details>
<summary><strong>Ai Boost Awesome Prompts</strong> (324 prompts)</summary>
...
| … | *+294 more* | See `scraped/ai-boost-awesome-prompts/` |
