...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2600 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2605 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2083 |
...
| AI Boost Awesome Prompts | github | [https://github.com/ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) | txt | 359 |

### Scraped Prompts

<details>
<summary><strong>Ai Boost Awesome Prompts</strong> (359 prompts)</summary>
...
| … | *+329 more* | See `scraped/ai-boost-awesome-prompts/` |
...
<details>
<summary><strong>Prompts Chat</strong> (2083 prompts)</summary>
...
| … | *+2053 more* | See `scraped/prompts-chat/` |
