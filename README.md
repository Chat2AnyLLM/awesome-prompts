...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2373 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2378 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 1908 |
...
<details>
<summary><strong>Prompts Chat</strong> (1908 prompts)</summary>
...
| … | *+1878 more* | See `scraped/prompts-chat/` |
