...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2523 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2528 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2026 |
...
<details>
<summary><strong>Prompts Chat</strong> (2026 prompts)</summary>
...
| … | *+1996 more* | See `scraped/prompts-chat/` |
