...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2448 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2453 |
...
| AI Boost Awesome Prompts | github | [https://github.com/ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) | txt | 322 |

### Scraped Prompts

<details>
<summary><strong>Ai Boost Awesome Prompts</strong> (322 prompts)</summary>
...
| … | *+292 more* | See `scraped/ai-boost-awesome-prompts/` |
