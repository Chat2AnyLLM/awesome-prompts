...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2586 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2591 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2072 |
...
<details>
<summary><strong>Prompts Chat</strong> (2072 prompts)</summary>
...
| … | *+2042 more* | See `scraped/prompts-chat/` |
