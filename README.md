...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2638 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2643 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2119 |
...
<details>
<summary><strong>Prompts Chat</strong> (2119 prompts)</summary>
...
| … | *+2089 more* | See `scraped/prompts-chat/` |
