...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2486 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2491 |
...
| AI Boost Awesome Prompts | github | [https://github.com/ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) | txt | 329 |

### Scraped Prompts

<details>
<summary><strong>Ai Boost Awesome Prompts</strong> (329 prompts)</summary>
...
| … | *+299 more* | See `scraped/ai-boost-awesome-prompts/` |
