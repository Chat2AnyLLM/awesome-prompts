...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2507 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2512 |
...
<details>
<summary><strong>Prompts Chat</strong> (2016 prompts)</summary>
...
| … | *+1986 more* | See `scraped/prompts-chat/` |
