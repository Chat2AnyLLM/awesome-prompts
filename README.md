...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2624 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2629 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2123 |
...
| AI Boost Awesome Prompts | github | [https://github.com/ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) | txt | 349 |

### Scraped Prompts

<details>
<summary><strong>Ai Boost Awesome Prompts</strong> (349 prompts)</summary>
...
| … | *+319 more* | See `scraped/ai-boost-awesome-prompts/` |
...
<details>
<summary><strong>Prompts Chat</strong> (2123 prompts)</summary>
...
| … | *+2093 more* | See `scraped/prompts-chat/` |
