...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2604 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2609 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2086 |
...
<details>
<summary><strong>Prompts Chat</strong> (2086 prompts)</summary>
...
| … | *+2056 more* | See `scraped/prompts-chat/` |
