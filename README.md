...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2657 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2662 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2134 |
...
<details>
<summary><strong>Prompts Chat</strong> (2134 prompts)</summary>
...
| … | *+2104 more* | See `scraped/prompts-chat/` |
