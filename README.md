...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2510 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2515 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2017 |
...
| AI Boost Awesome Prompts | github | [https://github.com/ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) | txt | 335 |

### Scraped Prompts

<details>
<summary><strong>Ai Boost Awesome Prompts</strong> (335 prompts)</summary>
...
| … | *+305 more* | See `scraped/ai-boost-awesome-prompts/` |
...
<details>
<summary><strong>Prompts Chat</strong> (2017 prompts)</summary>
...
| … | *+1987 more* | See `scraped/prompts-chat/` |
