...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2577 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2582 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2065 |
...
| AI Boost Awesome Prompts | github | [https://github.com/ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) | txt | 354 |

### Scraped Prompts

<details>
<summary><strong>Ai Boost Awesome Prompts</strong> (354 prompts)</summary>
...
| … | *+324 more* | See `scraped/ai-boost-awesome-prompts/` |
...
<details>
<summary><strong>Prompts Chat</strong> (2065 prompts)</summary>
...
| … | *+2035 more* | See `scraped/prompts-chat/` |
