...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2449 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2454 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 1968 |
...
| AI Boost Awesome Prompts | github | [https://github.com/ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) | txt | 323 |

### Scraped Prompts

<details>
<summary><strong>Ai Boost Awesome Prompts</strong> (323 prompts)</summary>
...
| … | *+293 more* | See `scraped/ai-boost-awesome-prompts/` |
...
<details>
<summary><strong>Prompts Chat</strong> (1968 prompts)</summary>
...
| … | *+1938 more* | See `scraped/prompts-chat/` |
