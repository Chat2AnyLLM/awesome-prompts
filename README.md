...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2557 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2562 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2052 |
...
<details>
<summary><strong>Prompts Chat</strong> (2052 prompts)</summary>
...
| … | *+2022 more* | See `scraped/prompts-chat/` |
