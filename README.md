...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2372 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2377 |
...
| AI Boost Awesome Prompts | github | [https://github.com/ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) | txt | 306 |

### Scraped Prompts

<details>
<summary><strong>Ai Boost Awesome Prompts</strong> (306 prompts)</summary>
...
| … | *+276 more* | See `scraped/ai-boost-awesome-prompts/` |
