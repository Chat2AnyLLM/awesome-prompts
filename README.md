...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2635 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2640 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2116 |
...
<details>
<summary><strong>Prompts Chat</strong> (2116 prompts)</summary>
...
| … | *+2086 more* | See `scraped/prompts-chat/` |
