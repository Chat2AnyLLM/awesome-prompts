...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2539 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2544 |
...
| AI Boost Awesome Prompts | github | [https://github.com/ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) | txt | 343 |

### Scraped Prompts

<details>
<summary><strong>Ai Boost Awesome Prompts</strong> (343 prompts)</summary>
...
| … | *+313 more* | See `scraped/ai-boost-awesome-prompts/` |
