...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2579 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2584 |
...
| AI Boost Awesome Prompts | github | [https://github.com/ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) | txt | 355 |

### Scraped Prompts

<details>
<summary><strong>Ai Boost Awesome Prompts</strong> (355 prompts)</summary>
...
| … | *+325 more* | See `scraped/ai-boost-awesome-prompts/` |
