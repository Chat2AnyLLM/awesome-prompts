...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2487 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2492 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 1999 |
...
| AI Boost Awesome Prompts | github | [https://github.com/ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) | txt | 330 |

### Scraped Prompts

<details>
<summary><strong>Ai Boost Awesome Prompts</strong> (330 prompts)</summary>
...
| … | *+300 more* | See `scraped/ai-boost-awesome-prompts/` |
...
<details>
<summary><strong>Prompts Chat</strong> (1999 prompts)</summary>
...
| … | *+1969 more* | See `scraped/prompts-chat/` |
