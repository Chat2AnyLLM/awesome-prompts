...
| Metric | Count |
|--------|-------|
| Unified prompts (in `dist/prompts.json`) | 2499 |
| Direct prompts (from `prompts/`) | 3 |
| Configured sources | 4 |
| Scraped prompts cached in `scraped/` | 2504 |
...
| Prompts Chat | github | [https://github.com/f/prompts.chat](https://github.com/f/prompts.chat) | csv | 2009 |
...
| AI Boost Awesome Prompts | github | [https://github.com/ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) | txt | 333 |

### Scraped Prompts

<details>
<summary><strong>Ai Boost Awesome Prompts</strong> (333 prompts)</summary>
...
| … | *+303 more* | See `scraped/ai-boost-awesome-prompts/` |
...
<details>
<summary><strong>Prompts Chat</strong> (2009 prompts)</summary>
...
| … | *+1979 more* | See `scraped/prompts-chat/` |
